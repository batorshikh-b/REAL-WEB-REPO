...
const en = {
  ...
  services: [
    ...
    { id: "datacenter", number: "03", tag: "DATACENTER", title: "Server Hosting & Datacenter", description: "Secure, high-availability server hosting and datacenter management with proactive monitoring, backup, and scalable capacity.", stat1: { value: "24/7", label: "monitoring" }, stat2: { value: "< 99.9%", label: "uptime SLA" }, visual: "datacenter" },
    ...
    { id: "development", number: "05", tag: "DEVELOPMENT", title: "System Development Support", description: "End-to-end support for custom systems — feature development, bug resolution, performance tuning, and long-term technical stewardship.", stat1: { value: "20+", label: "years experience" }, stat2: { value: "20+", label: "engineers" }, visual: "development" },
  ] satisfies Service[],
};
...
const mn = {
  ...
  services: [
    ...
    { id: "datacenter", number: "03", tag: "ДАТАЦЕНТР", title: "Сервер & Датацентрийн үйлчилгээ", description: "Аюулгүй, өндөр хүртээмжтэй серверийн хостинг болон датацентрийн удирдлага — идэвхтэй хяналт, нөөцлөлт, уян хатан хүчин чадал.", stat1: { value: "24/7", label: "хяналт" }, stat2: { value: "< 99.9%", label: "ажиллагаа" }, visual: "datacenter" },
    ...
    { id: "development", number: "05", tag: "ХӨГЖҮҮЛЭЛТ", title: "Систем хөгжүүлэлтийн үйлчилгээ", description: "Тусгай системийн эхнээс эцэс хүртэлх дэмжлэг — шинэ боломжуудыг нэмэх, алдааг засах, гүйцэтгэлийг сайжруулах.", stat1: { value: "20+", label: "жилийн туршлага" }, stat2: { value: "20+", label: "инженер" }, visual: "development" },
  ] satisfies Service[],
};
