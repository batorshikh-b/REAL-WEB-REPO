      ...
      <div style={barStyle}>
            ...
            <div style={{ position: "relative", width: "100%", maxWidth: "320px", display: "flex", alignItems: "center" }}>
              ...
              <input
                ...
                style={{
                  ...
                  background: t.inputBg, color: t.inputText, fontSize: "0.9rem",
                  transition: "background 0.3s ease, color 0.3s ease",
                }}
              />
            </div>
        ...
        {isAppBar && (
          <div style={{ ...appBarSectionStyle, flex: 1, justifyContent: "flex-end" }}>
            ...
            {appBarProps?.userAvatar !== undefined ? appBarProps.userAvatar : (
              <div style={{ width: "32px", height: "32px", borderRadius: "50%", background: t.inputBg, display: "flex", alignItems: "center", justifyContent: "center", color: t.inputText }}>
                <UserIcon />
              </div>
            )}
            <button
